...
// DEBIT TRANSACTION
function withdrawAmount($req)
{
    // print_r('------------------<br>');
    // print_r('REQUEST : withdrawAmount<br>');
    // print_r('------------------<br>');
    // print_r($req['body']);
    // print_r('------------------');
    ...
    try {
        ...
        $SETTLEMENT_ACCOUNT_TYPE = $SETTLEMENT["account_type"]; // no settlement is involved for CASH transaction. So 'NA' will be received.
        $SETTLEMENT_ACCOUNT_NUMBER = $SETTLEMENT["account_number"]; // will be empty for CASH transactions.
        ...
        $DEBIT_CONFIRM_RESULT = array(
            "code" => RESULT_CODE_HOLD,
            "status" => STATUS_HOLD,
            "message" => RESULT_MESSAGE_E1002,
        );
...
function withdrawSuccess($req)
{
    ...
    */
    ...
    // print_r('<br>------------------<br>');
    // print_r('<br>REQUEST : withdrawSuccess');
    // print_r('<br>------------------');
    ...
    try {
        ...
        // print_r('*****************');
        // print_r('DEBIT_CONFIRM - RESPONSE');
        // print_r($DEBIT_CONFIRM);
        // print_r('*****************');

        return $DEBIT_CONFIRM;
    } catch (Exception $e) {
